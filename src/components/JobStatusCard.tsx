        ...
        <div className="flex-1 min-w-0">
          ...
          {job.status === 'error' && isCalendarPermissionError && (
            <div className="mt-2 space-y-2">
              ...
              <button
                onClick={() => { navigator.vibrate?.(10); setIsModalOpen(true) }}
                className="inline-flex items-center gap-1.5 text-xs font-medium text-red-600 underline underline-offset-2 hover:text-red-700 cursor-pointer transition"
              >
