...
function LoginContent() {
  ...
  const handleGoogleLogin = async () => {
    ...
    await supabase.auth.signInWithOAuth({
      ...
      options: {
        ...
        // offline_access でリフレッシュトークンを取得
        // Google Calendar Events のスコープを追加
        scopes: [
        ...
        queryParams: {
          access_type: 'offline',
          prompt: 'consent', // 毎回同意画面を出すことで refresh_token を確実に取得
        },
      },
    })
  }
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-gradient-to-br from-green-50 to-teal-100">
