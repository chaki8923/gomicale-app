...
export const metadata: Metadata = {
  ...
  description: 'PDFのゴミ出しカレンダーや予定表をAIが解析し、Googleカレンダーに一括自動登録。手入力の手間をゼロにする無料サービスです。「PDFからカレンダー登録」をたった1分で実現。',
  keywords: ['PDF', 'Googleカレンダー', 'カレンダー登録', '自動登録', 'ゴミ出しカレンダー', '予定表', 'AI解析', '予定抽出'],
  authors: [{ name: 'ゴミカレ' }],
  creator: 'ゴミカレ',
  publisher: 'ゴミカレ',
  icons: {
  ...
  openGraph: {
    ...
    description: 'PDFのゴミ出しカレンダーや予定表をAIが解析し、Googleカレンダーに一括自動登録。手入力の手間をゼロにする無料サービスです。',
    siteName: 'ゴミカレ',
    images: [
      {
        url: 'https://gomicale.jp/og-image.png', // OG画像がある想定（必要に応じて後で追加）
        width: 1200,
        height: 630,
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  const jsonLd = {
    ...
    description: 'PDFのゴミ出しカレンダーや予定表をAIが解析し、Googleカレンダーに一括自動登録する無料サービス。',
    url: 'https://gomicale.jp',
    offers: {
      '@type': 'Offer',
      price: '0',
